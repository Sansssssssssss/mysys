package com.mysys.common.core.text;
...
public class Convert {
     ...
     * @return 结果
     */
    public static Long[] toLongArray(String split,
                                     String str) {
        if (StringUtils.isEmpty(str)) {
            return new Long[]{};
        }
     ...
     * @return 结果
     */
    public static String[] toStrArray(String split,
                                      String str) {
     ...
     * @return Enum
     */
    public static <E extends Enum<E>> E toEnum(Class<E> clazz,
                                               Object value,
                                               E defaultValue) {
        if (value == null) {
            return defaultValue;
     ...
     * @return 字符串
     */
    public static String str(ByteBuffer data,
                             String charset) {
        if (data == null) {
            return null;
        }
