package com.mysys.common.utils;

import com.mysys.common.constant.Constants;
import com.mysys.common.core.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * @return set集合
     */
    public static final Set<String> str2Set(String str,
                                            String sep) {
     ...
     * @return 包含返回true
     */
    public static boolean inStringIgnoreCase(String str,
                                             String... strs) {
     ...
     */
    public static final String padl(final Number num,
                                    final int size) {
     ...
     */
    public static final String padl(final String s,
                                    final int size,
                                    final char c) {
